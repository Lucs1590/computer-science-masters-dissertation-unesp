...
Resumindo, a complexidade é expressa como $O(HWD * \min(P^2, ND))$, onde $P$ é o tamanho dos \textit{patches}, $N$ é o número de componentes principais, e $D$ é a quantidade de blocos.
...
\begin{figure}[H]
    \centering
    \caption[Substituição das camadas de \textit{pooling} por BPCAPooling - CIFAR-100.]{Demonstração da substituição das camadas de \textit{pooling} convencionais por BPCAPooling no conjunto de dados CIFAR-100. Os números sob cada camada representam o número de parâmetro.}
...
\begin{table}[H]
    \centering
    \caption[Treinamento e Teste VGG-16 + BPCAPooling (\textit{Food}-101)]{Parâmetros de treinamento e teste com VGG-16 e BPCAPooling no conjunto \textit{Food}-101.}
...
\begin{table}[H]
    \centering
    \caption[Treinamento e Teste VGG-16 + \textit{Max Pooling} (\textit{Food}-101)]{Parâmetros de treinamento e teste com VGG-16 e \textit{Max Pooling} no conjunto \textit{Food}-101.}
...
\begin{table}[H]
    \centering
    \caption[Treinamento e Teste VGG-16 + \textit{Avg Pooling} (\textit{Food}-101)]{Parâmetros de treinamento e teste com VGG-16 e \textit{Avg Pooling} no conjunto \textit{Food}-101.}
...
\begin{table}[H]
    \centering
    \caption[Treinamento e Teste VGG-16 + BPCAPooling (CIFAR 100)]{Parâmetros de treinamento e teste com VGG-16 e BPCAPooling no conjunto CIFAR 100.}
...
\begin{table}[H]
    \centering
    \caption[Treinamento e Teste VGG-16 + \textit{Max Pooling} (CIFAR 100)]{Parâmetros de treinamento e teste com VGG-16 e \textit{Max Pooling} no conjunto CIFAR 100.}
...
\begin{table}[H]
    \centering
    \caption[Treinamento e Teste VGG-16 + \textit{Avg Pooling} (CIFAR 100)]{Parâmetros de treinamento e teste com VGG-16 e \textit{Avg Pooling} no conjunto CIFAR 100.}

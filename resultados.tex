...
No próximo capítulo, as conclusões derivadas deste trabalho serão apontadas, à luz dos objetivos estabelecidos no início deste estudo (Seção \ref{intro:objectives}), além de sugestões de trabalhos futuros.